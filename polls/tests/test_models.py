...
from polls.models import Choice, Question, ChoiceVote, PollsIndexPage
...
class ModelsTestCase(MoloTestCaseMixin, TestCase):
    ...
    def test_section_page_question(self):
        ...
        self.section_index.add_child(instance=section)
        ...
        response = self.client.get('/sections/section/')
    ...
    def test_poll_vote(self):
        ...
        client = Client()
        client.login(username='superuser', password='pass')
        client.post(reverse('polls:vote',
